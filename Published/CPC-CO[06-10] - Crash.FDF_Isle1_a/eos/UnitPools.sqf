...
// RHS ChDKZ Insurgents
	if (_faction == 5) then {
	_InfPool=	["rhsgref_ins_rifleman", "rhsgref_ins_rifleman_akm", "rhsgref_ins_rifleman_aksu", "rhsgref_ins_grenadier", "rhsgref_ins_rifleman_RPG26", "rhsgref_ins_militiaman_mosin", "rhsgref_ins_medic", "rhsgref_ins_machinegunner"];	
	_ArmPool=	["rhsgref_ins_t72ba", "rhsgref_ins_btr60s", "rhsgref_BRDM2_ins"];
	_MotPool=	["rhsgref_ins_uaz_open", "rhsgref_ins_uaz_dshkm", "rhsgref_ins_gaz66o"];
	_ACHPool=	["rhsgref_ins_Mi8amt"];
	_CHPool=	["rhsgref_ins_Mi8amt"];
	_uavPool=	[];
	_stPool=	["rhsgref_ins_2b14", "rhsgref_ins_DSHKM", "rhsgref_ins_SPG9", "rhsgref_ins_ZU23"];
	_shipPool=	[];
	_diverPool=	[];
	_crewPool=	["rhsgref_ins_crew", "rhsgref_ins_rifleman_aksu", "rhsgref_ins_rifleman", "rhsgref_ins_rifleman_akm"];
	_heliCrew=	["rhsgref_ins_pilot"];
	};
