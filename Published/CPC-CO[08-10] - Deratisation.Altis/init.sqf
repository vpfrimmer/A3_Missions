...
["Environnement", "Il est 12h00, le temps est clair et aucune perturbation n'est à prévoir."]];

player createDiaryRecord ["Diary", 
["Equipement et supports", "Vous disposez pour cette mission d'un hélicoptère Kajman, capable de transporter 8 passagers et armé d'une mitrailleuse de 30mm, de 8 missiles filoguidés air-sol, et de 38 roquettes air-sol non guidées. Plusieurs camions de refueling et réarmement sont disponibles près de l'héliport de la base."]];

player createDiaryRecord ["Diary", 
["Exécution", "1. Localisez le camp ennemi et sécurisez-le.<br/>2. Fouillez le camp à la recherche d'informations.<br/>3. Retournez à <marker name='mrkBase'>la base.</marker><br/><br/>N'importe qui peut terminer la mission via un trigger radio."]];

player createDiaryRecord ["Diary", 
["Renseignements", "- Notre dernier appareil a avoir survolé la zone a pu localiser <marker name='mrkAA_15'>un des sites anti-aériens ennemi.</marker> Peut-être y trouverez vous des informations sur place.<br/>- Les forces ennemies manquent de moyens et ne sont constituées que d'infanterie et de véhicules légers."]];

player createDiaryRecord ["Diary", 
["Objectif secondaire", "Nous savons qu'un nombre indéterminé de sites anti-aériens ennemis se trouvent dans la zone d'opération. Essayez de les neutraliser.<br/>Ceci n'est pas un objectif obligatoire."]];

player createDiaryRecord ["Diary", 
["Objectif", "Nous savons qu'un camp rebel se cache dans <marker name='mrkZone'>la campagne nord-est d'Altis.</marker> Votre objectif est de le localiser et de le fouiller à la recherche d'informations."]];

player createDiaryRecord ["Diary", 
["Situation", "Le CSAT a pris possession d'Altis, mais des poches de rebelles de la FIA composées de locaux et d'ancien membre de l'OTAN s'organisent.<br/>Vous faites partie d'une équipe du CSAT chargée de nettoyer le nord-ouest de l'île, d'où plusieurs missiles anti aériens rebels sont partis ces derniers jours."]];
