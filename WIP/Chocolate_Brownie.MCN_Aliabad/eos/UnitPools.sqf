...
// TAKISTANI ARMY
	if (_faction==5) then {
	_InfPool=	["CUP_O_TK_Engineer", "CUP_O_TK_Soldier_GL", "CUP_O_TK_Soldier_MG", "CUP_O_TK_Engineer", "CUP_O_TK_Medic", "CUP_O_TK_Soldier", "CUP_O_TK_Soldier_LAT", "CUP_O_TK_Sniper", "CUP_O_TK_Soldier_HAT", "CUP_O_TK_Soldier_SL"];	
	_ArmPool=	["CUP_O_T55_TK", "CUP_O_T34_TKA"];
	_MotPool=	["CUP_O_LR_MG_TKA", "CUP_O_UAZ_MG_TKA", "CUP_O_UAS_AGS30_TKA"];
	_ACHPool=	["CUP_O_Mi24_D_TK"];
	_CHPool=	["CUP_O_UH1H_TKA", "CUP_O_Mi17_TK"];
	_uavPool=	[];
	_stPool=	["CUP_O_KORD_TK","CUP_O_Metis_TK","CUP_O_ZU23_TK"];
	_shipPool=	[];
	_diverPool=	[];
	_crewPool=	["CUP_O_TK_Crew"];
	_heliCrew=	["CUP_O_TK_Pilot"];
	};
	
// RUSSIA	
	if (_faction==6) then {
	_InfPool=	["CUP_O_RU_Soldier_EMR", "CUP_O_RU_Soldier_LAT_EMR", "CUP_O_RU_Soldier_GL_EMR", "CUP_O_RU_Soldier_MG_EMR", "CUP_O_RU_Sniper_EMR", "CUP_O_RU_Soldier_TL_EMR","CUP_O_RU_Soldier_Marksman_EMR"];	
	_ArmPool=	["CUP_O_T72_RU", "CUP_O_BMP2_RU", "CUP_O_BTR90_RU"];
	_MotPool=	["CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_UAZ_MG_RU"];
	_ACHPool=	["CUP_O_Mi24_V_RU"];
	_CHPool=	["CUP_O_Mi8_RU"];
	_uavPool=	[];
	_stPool=	["CUP_O_KORD_high_RU", "CUP_O_AGS_RU", "CUP_O_Metis_RU", "CUP_O_ZU23_RU"];
	_shipPool=	[];
	_diverPool=	[];
	_crewPool=	["CUP_O_RU_Crew_EMR"];
	_heliCrew=	["CUP_O_RU_Pilot_EMR"];
	};
	
// USA	
	if (_faction==7) then {
	_InfPool=	["CUP_B_US_Soldier", "CUP_B_US_Soldier_AR", "CUP_B_US_Soldier_GL", "CUP_B_US_Soldier_MG", "CUP_B_US_Soldier_Marksman", "CUP_B_US_Medic", "CUP_B_US_Soldier_LAT", "CUP_B_US_Soldier_TL"];	
	_ArmPool=	["CUP_B_M6LineBacker_USA_D", "CUP_B_M1A1_DES_US_Army", "CUP_B_M2Bradley_USA_D"];
	_MotPool=	["CUP_B_HMMWV_M2_USA", "CUP_B_M1130_CV_M2_Desert_Slat"];
	_ACHPool=	["CUP_B_AH64D_ES_USA", "CUP_B_AH6J_Escort_USA"];
	_CHPool=	["CUP_B_UH60M_US"];
	_uavPool=	[];
	_stPool=	["CUP_B_M2StaticMG_US"];
	_shipPool=	[];
	_diverPool=	[];
	_crewPool=	["CUP_B_US_Crew"];
	_heliCrew=	["CUP_B_US_Pilot_Light"];
	};
