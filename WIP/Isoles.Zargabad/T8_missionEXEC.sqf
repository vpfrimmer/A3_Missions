...
_patrol = [ "rhs_msv_emr_sergeant", "rhs_msv_emr_grenadier", "rhs_msv_emr_rifleman", "rhs_msv_emr_medic" ];
...
[
	...
	[ [ _patrol, "1" ], [ "PATROL URBAN" ], [ true, true, true ]]
];
...
/*
[ patrolContainer ] spawn T8U_fnc_Spawn;
[ cityContainer ] spawn T8U_fnc_Spawn;
[ baseContainer ] spawn T8U_fnc_Spawn;
*/
