...
["Environnement", "Il est 12h, le ciel est beau. Rien à signaler."]];
...
player createDiaryRecord ["Diary", 
["Renseignements", "Fallujah est aux mains de milices locales, armées d'AK et de RPG-7, pas ou peu motorisée. Toute force se trouvant dans la zone d'opération est à considérer comme hostile. Méfiez-vous des toits et des angles de rue.<br/><br/>Des barricades ont été repérées dans la ville, attendez vous à ce que certaines rues soient obstruées."]];
...
player createDiaryRecord ["Diary", 
["Mission", "Il y a quelques minutes, un hélicoptère médical s'est écrasé à quelques centaines de mètre de votre position après avoir subi un tir de roquette. Cet hélicoptère transportait deux pilotes et un officier américain. D'après leur dernière communication, ils étaient en vie, bien que blessés.<br/>Vous êtes les plus proches du site du crash, c'est donc à vous que revient la mission d'aller sauver ces hommes.<br/><br/>Une fois récupérés, ramenez-les à l'hopital."]];

player createDiaryRecord ["Diary", 
["Situation", "Irak, 16 Juin 2007<br/>La province d'Al-Anbâr et sa ville sont dans la tourmente. Depuis la guerre, le pays ne s'est toujours pas stabilisé politiquement et de nombreuses milices s'affrontent.<br/>Vous faites partie d'un petit groupement américain actuellement affecté à la sécurité d'un hopital aux abords de la ville."]];
