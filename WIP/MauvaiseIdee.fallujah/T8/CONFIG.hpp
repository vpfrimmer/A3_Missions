...
T8U_var_enableFatigue			= true;		// enable/disable Fatigue for all spawned units
...
T8U_var_ReinforceVehicle = [	"CUP_O_V3S_Open_TKM" ];

T8U_var_SuppressingUnits = [	"CUP_O_TK_INS_Soldier_MG" ];
